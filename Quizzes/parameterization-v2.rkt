...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname parameterization-v2-own) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
;; given a predicate and a list, produce a list of elements that fulfill the predicate
...
(check-expect (filter2 string? (list "s" 1 "toro" 3)) (list "s" "toro"))
